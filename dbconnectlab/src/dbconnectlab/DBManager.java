...
public class DBManager {
	...
	public DBManager() throws SQLException{
			...
			String url="jdbc:sqlserver://127.0.0.1;instanceName=MSSQLSERVERNEW;databaseName=BIIT;encrypt=true;trustServerCertificate=true";// databaseName=your database name
